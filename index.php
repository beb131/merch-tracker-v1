...
<form action="./form_submit.php" method="POST">
    ...
    <!--/section-->
    <!--________________________________-->
    <!--___________DYED CROP TOPS_________-->
    <!--________________________________-->
    <div id="dyed_crop-top_container" class="section">
        <h1>Dyed Crop Tops</h1>
        <div id="box_container">
            <div class="box_border">
                <p>
                    <h2>X Small / Small</h2>
                    <button id="dyed-crop-XS" type="button" onclick="decQuantity(this.id, 'DyedCrop')" class="button1">-1</button>
                    <input id="dyed-crop-XS-quantity" class="form_female" type="number" min="0" name="dyed-crop-XS-quantity">
                    <input id="dyed-crop-XS-earn" class="form_female" placeholder="$$$" type="number" min="0" name="dyed-crop-XS-earn">
                    <button id="dyed-crop-XS" type="button" onclick="incQuantity(this.id, 'DyedCrop')" class="button1">+1</button>
            </div>
            <div class="box_border">
                <p>
                    <h2>Medium / Large:</h2>
                    <button id="dyed-crop-M" type="button" onclick="decQuantity(this.id, 'DyedCrop')" class="button1">-1</button>
                    <input id="dyed-crop-M-quantity" class="form_female" type="number" min="0" name="dyed-crop-M-quantity">
                    <input id="dyed-crop-M-earn" class="form_female" placeholder="$$$" type="number" min="0" name="dyed-crop-M-earn">
                    <button id="dyed-crop-M" type="button" onclick="incQuantity(this.id, 'DyedCrop')" class="button1">+1</button>
            </div>
        </div>
    </div>
    <!--/section-->
    <!--________________________________-->
    <!--___________DYED TANK TOPS_________-->
    <!--________________________________-->
    <div id="dyed_tank-top_container" class="section">
        <h1>Dyed Tank Tops</h1>
        <div id="box_container">
            <div class="box_border">
                <p>
                    <h2>Small</h2>
                    <button id="dyed-tank-S" type="button" onclick="decQuantity(this.id, 'DyedTank')" class="button1">-1</button>
                    <input id="dyed-tank-S-quantity" class="form_male" type="number" min="0" name="dyed-tank-S-quantity">
                    <input id="dyed-tank-S-earn" class="form_male" placeholder="$$$" type="number" min="0" name="dyed-tank-S-earn">
                    <button id="dyed-tank-S" type="button" onclick="incQuantity(this.id, 'DyedTank')" class="button1">+1</button>
            </div>
            <div class="box_border">
                <p>
                    <h2>Medium</h2>
                    <button id="dyed-tank-M" type="button" onclick="decQuantity(this.id, 'DyedTank')" class="button1">-1</button>
                    <input id="dyed-tank-M-quantity" class="form_male" type="number" min="0" name="dyed-tank-M-quantity">
                    <input id="dyed-tank-M-earn" class="form_male" placeholder="$$$" type="number" min="0" name="dyed-tank-M-earn">
                    <button id="dyed-tank-M" type="button" onclick="incQuantity(this.id, 'DyedTank')" class="button1">+1</button>
            </div>
            <div class="box_border">
                <p>
                    <h2>Large</h2>
                    <button id="dyed-tank-L" type="button" onclick="decQuantity(this.id, 'DyedTank')" class="button1">-1</button>
                    <input id="dyed-tank-L-quantity" class="form_male" type="number" min="0" name="dyed-tank-L-quantity">
                    <input id="dyed-tank-L-earn" class="form_male" placeholder="$$$" type="number" min="0" name="dyed-tank-L-earn">
                    <button id="dyed-tank-L" type="button" onclick="incQuantity(this.id, 'DyedTank')" class="button1">+1</button>
            </div>
            <div class="box_border">
                <p>
                    <h2>Extra Large</h2>
                    <button id="dyed-tank-XL" type="button" onclick="decQuantity(this.id, 'DyedTank')" class="button1">-1</button>
                    <input id="dyed-tank-XL-quantity" class="form_male" type="number" min="0" name="dyed-tank-XL-quantity">
                    <input id="dyed-tank-XL-earn" class="form_male" placeholder="$$$" type="number" min="0" name="dyed-tank-XL-earn">
                    <button id="dyed-tank-XL" type="button" onclick="incQuantity(this.id, 'DyedTank')" class="button1">+1</button>
            </div>
        </div>
    </div>
    <!--/section-->
