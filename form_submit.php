...
//DYED CROP TOPS
foreach ($shirt_sizes as $currSize) {
    $dyed_crop_earn = $_POST['dyed-crop-' . $currSize . '-earn'];
    $dyed_crop_quantity = $_POST['dyed-crop-' . $currSize . '-quantity'];
...
//DYED TANK TOPS
foreach ($shirt_sizes as $currSize) {
    $dyed_tank_earn = $_POST['dyed-tank-' . $currSize . '-earn'];
    $dyed_tank_quantity = $_POST['dyed-tank-' . $currSize . '-quantity'];
